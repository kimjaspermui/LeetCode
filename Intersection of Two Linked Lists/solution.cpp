...
public:
    ...
    ListNode *getIntersectionNode(ListNode *headA, ListNode *headB) {
        ...
        // keep moving A until they start at the same position if they will interesect (case when sizeA is larger)
        while (sizeA > sizeB) {
        ...
        // keep moving B until they start at the same position if they will interesect (case when sizeB is larger)
        while (sizeB > sizeA) {
